...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridModelos" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ModeloID" HtmlEncode="False" DataFormatString="<a href='ActualizarModelo.aspx?modeloid={0}'><img src='Icons/Edit.png' width='25px' height='25px'/></a>" />            
            <asp:BoundField DataField="ModeloID" HtmlEncode="False" DataFormatString="<a href='EliminarModelo.aspx?modeloid={0}'><img src='Icons/Delete.png' width='25px' height='25px'/></a>" />            
        </Columns>
